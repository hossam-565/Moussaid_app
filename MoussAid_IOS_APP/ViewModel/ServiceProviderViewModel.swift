...
class ServiceProviderViewModel: NSObject, ObservableObject, CLLocationManagerDelegate {
    ...
    @Published var mapRegion = MKCoordinateRegion(
        center: CLLocationCoordinate2D(latitude: 35.7529831, longitude: -5.8060561),
